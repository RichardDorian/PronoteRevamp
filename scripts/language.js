...
const translations = {
  en: {
    ...
    'settings-text-theme-amoled': 'AMOLED',
    ...
    'settings-text-notification-grades': 'Grades',
    'settings-text-notification-homework': 'Homework',
    // Time table
  ...
  fr: {
    ...
    'settings-text-notification-grades': 'Notes',
    'settings-text-notification-homework': 'Devoirs',
  ...
  es: {
    ...
    'settings-text-notification-grades': 'Notas',
    'settings-text-notification-homework': 'Tareas',
